  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-50 to-blue-50 text-gray-800">
      <section className="mx-auto max-w-6xl px-6 pt-28 pb-16 text-center">
        ...
        {/* Mapa */}
        <div className="relative mx-auto mb-10 w-full overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl shadow-gray-300">
          <iframe
        ...
        {/* Tarjeta de contacto */}
        <div className="mx-auto flex max-w-md flex-col items-center gap-6 rounded-2xl bg-white/90 p-6 shadow-lg shadow-gray-200 ring-1 ring-gray-200">
